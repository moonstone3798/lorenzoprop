...
<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="/modificarAlquiler" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <label> Dirección: </label>
               <br>
                <input type="text" name="dirección"
                       value="{{ old('dirección', $Renta->dirección) }}"
                       class="form-control">
                <br><br>
                <label>Precio: </label>
           <br>
                <input type="text" name="precio"
                       value="{{ old('precio', $Renta->precio) }}"
                       class="form-control">
                <br><br>
                <label>Descripción: </label>
                <br>
                <input type="text" name="descripción"
                       value="{{ old('descripción', $Renta->descripción) }}"
                       class="form-control">
                <br><br>

                <label>Imagen actual 1:</label> <br>
                <img src="/rentas/{{ $Renta->imagen }}" class="img-thumbnail my-2" ><br>
                ...
                <img src="/rentas/{{ $Renta->imagen2 }}" class="img-thumbnail my-2" ><br> 
                <label>  Imagen nueva (opcional):</label><br>
                <div class="custom-file mt-1 mb-4">
                ...
                <img src="/rentas/{{ $Renta->imagen3 }}" class="img-thumbnail my-2"><br>
                <label>  Imagen nueva (opcional):</label><br>
                <div class="custom-file mt-1 mb-4">
                ...
                <img src="/rentas/{{ $Renta->imagen4 }}" class="img-thumbnail my-2" > <br>
                <label>  Imagen nueva (opcional):</label> <br>
                <div class="custom-file mt-1 mb-4">
                ...
                <img src="/rentas/{{ $Renta->imagen5 }}" class="img-thumbnail my-2" ><br>
                <label>  Imagen nueva (opcional):</label><br>
                <div class="custom-file mt-1 mb-4">
                ...
                <br>
                <button class="btn btn-dark mb-3" style="margin-left:37%; background: whitesmoke; margin-right:10px">Modificar Alquiler</button>
                <button> <a href="/adminAlquileres" class="btn btn-outline-secondary mb-3" style="text-decoration: none; color:black; background: whitesmoke">
